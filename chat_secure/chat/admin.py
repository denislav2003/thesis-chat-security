...
class ChatModelAdmin(admin.ModelAdmin):
    ...
    search_fields = ('id', 'user1__email', 'user1__name', 'user2__email', 'user2__name')
...
class MessageModelAdmin(admin.ModelAdmin):
    ...
    def has_file(self, obj):
        return 'Yes' if obj.file else 'No'
...
class UploadedFileAdmin(admin.ModelAdmin):
    list_display = ('id_short', 'file_name', 'get_uploader_email', 'chat_id_link', 
                    'file_size', 'upload_date')
    list_display_links = ('id_short', 'file_name')
    list_filter = ('upload_date',)
    search_fields = ('uploaded_by__email', 'file', 'chat__id', 'id')
